...
cd "/home/$USER/Documents/My Games/Far Cry 2/Benchmarks/Results"
rm BenchmarkReport1.csv

cd "$WINEPREFIX/drive_c/Program Files (x86)/Steam/steamapps/common/Far Cry 2/bin"

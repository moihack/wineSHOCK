...
fps=$(grep -o "Average FPS: [0-9][0-9].[0-9][0-9]" "C:/pts-benchmarks/crysis/Game/Levels/island/benchmark_gpu.log" | grep -o [0-9][0-9].[0-9][0-9] | awk '\''{ total += $1; count++ } END { print total/count }'\'')
